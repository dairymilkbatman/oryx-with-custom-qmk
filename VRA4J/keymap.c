...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DEF] = LAYOUT_voyager(
    ...
    XXXXXXX, _______, _______, _______, KC_ESCAPE, _______,                           _______, KC_BSPC, _______, _______, _______,  XXXXXXX,
                                        MO(1),     KC_LSFT,                           KC_SPACE, MO(3)
  ),
  [NAV] = LAYOUT_voyager(
    _______, KC_ESCAPE,     SW_WIN,         TAB_L,          TAB_R,         CW_TOGG,   KC_PAGE_UP, KC_HOME, KC_UP, KC_END,    KC_CAPS,   _______,
    _______, OSM(MOD_LSFT), OSM(MOD_LCTL),  OSM(MOD_LALT),  OSM(MOD_LGUI), KC_RALT,   KC_PGDN,    KC_LEFT, KC_DOWN, KC_RIGHT, KC_DELETE, _______,
  ...
  [FUN] = LAYOUT_voyager(
    _______, KC_MPRV, KC_MSTP,  KC_MPLY, KC_MNXT, KC_F15,                             KC_F12,   KC_F7,    KC_F8,   KC_F9,   RGB_TOG, _______,
    _______, KC_LSFT,  KC_LCTL,   KC_LALT,    KC_LGUI,  KC_F14,                       KC_F11,   KC_F4,    KC_F5,   KC_F6,   _______, _______,
  ...
  [NUM] = LAYOUT_voyager(
    ...
    _______, KC_KP_ASTERISK, KC_4,      KC_5,       KC_6,     KC_KP_MINUS,            KC_RALT,  KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, _______,
...
const uint16_t PROGMEM combo0[] = { KC_LSFT, KC_SLASH, COMBO_END};
const uint16_t PROGMEM combo1[] = { KC_LSFT, KC_QUOTE, COMBO_END};
const uint16_t PROGMEM combo2[] = { KC_LSFT, MO(3), COMBO_END};
